...
import static net.fabricmc.example.ForgeDirection.*;
...
public class RotationHelper {
    ...
    public static ForgeDirection[] getValidVanillaBlockRotations(Block block)
    {
        return (block instanceof BlockBed ||
                ...
                block instanceof BlockDetectorRail ||
    ...
    public static boolean rotateVanillaBlock(Block block, World worldObj, int x, int y, int z, ForgeDirection axis)
    {
        ...
        if (axis == UP || axis == DOWN)
        {
            ...
            if (block instanceof BlockChest || block instanceof BlockEnderChest || block instanceof BlockFurnace || block instanceof BlockLadder || block == Block.signWall)
            {
        ...
        if (block instanceof BlockTorch || block instanceof TorchBlockBase) // btw added
        {
        ...
        if (block.canRotateOnTurntable(worldObj, x, y, z)) {
            return block.rotateAroundJAxis(worldObj, x, y, z, false);
        }
