...
import static com.github.lunatrius.schematica.config.Property.Type.*;
...
public class Configuration {
    ...
    public Configuration(File file) {
        ...
        try {
            ...
            Reference.logger.fatal("An exception occurred while loading config file {}. This file will be renamed to {} " + "and a new config file will be generated.", file.getName(), fileBak.getName(), e);
    ...
    public void copyCategoryProps(Configuration fromConfig, String[] ctgys) {
        ...
        for (String ctgy : ctgys)
            if (fromConfig.hasCategory(ctgy) && this.hasCategory(ctgy)) {
                ...
                for (Map.Entry<String, Property> entry : thiscc.getValues().entrySet())
    ...
    public float getFloat(String name, String category, float defaultValue, float minValue, float maxValue, String comment, String langKey) {
        ...
        try {
            ...
            return constrainToRange(parseFloat, minValue, maxValue);
        }
        catch (Exception e) {
