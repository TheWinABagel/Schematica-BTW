...
public class GuiSchematicLoad extends GuiScreenBase {
    ...
    private final String strTitle = I18n.getString(Names.Gui.Load.TITLE);
    private final String strFolderInfo = I18n.getString(Names.Gui.Load.FOLDER_INFO);
    ...
    protected void actionPerformed(GuiButton guiButton) {
        if (guiButton.enabled) {
            if (guiButton.id == this.btnOpenDir.id) {
                ...
                if (Schematica.getProxy().isLoadEnabled) {
                    loadSchematic();
                }
