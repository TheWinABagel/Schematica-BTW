package com.github.lunatrius.schematicaold.client.renderer;

import com.github.lunatrius.schematicaold.SchematicWorld;
import com.github.lunatrius.schematicaold.Settings;
import net.fabricmc.example.mixin.TextureMapAccessor;
	...
	private void bindTexture() {
		...
		if (!resourcePacks.containsKey(resourcePackName)) {
			...
			try {
				...
				Map<String, TextureAtlasSprite> map = (Map<String, TextureAtlasSprite>) ((TextureMapAccessor) this.minecraft.renderEngine.getTexture(TextureMap.locationBlocksTexture)).getMapUploadedSprites();
//				Map<String, TextureAtlasSprite> map = (Map<String, TextureAtlasSprite>) this.fieldMapTexturesStiched.get(this.minecraft.renderEngine.getTexture(TextureMap.locationBlocksTexture));
				...
				for (TextureAtlasSprite sprite : sprites) {
					ResourceLocation resourcelocation = new ResourceLocation(fixDomain("textures/blocks/", sprite.getIconName()) + ".png");

					try {
						sprite.loadSprite(manager.getResource(resourcelocation));
