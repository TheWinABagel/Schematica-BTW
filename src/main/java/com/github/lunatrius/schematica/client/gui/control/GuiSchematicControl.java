...
public class GuiSchematicControl extends GuiScreenBase {
    ...
    private final String strSaveCoordinatesSuccess = I18n.getString(Names.Chat.SAVE_COORDINATES_SUCCESS);
    private final String strSaveCoordinatesFail = I18n.getString(Names.Chat.SAVE_COORDINATES_FAIL);
    private final String strSaveCoordinates = I18n.getString(Names.Gui.Control.SAVE_COORDINATES);

    private final String strMoveSchematic = I18n.getString(Names.Gui.Control.MOVE_SCHEMATIC);
    private final String strOperations = I18n.getString(Names.Gui.Control.OPERATIONS);
    private final String strName = I18n.getString(Names.Gui.Control.NAME);
    private final String strUnload = I18n.getString(Names.Gui.Control.UNLOAD);
    private final String strAll = I18n.getString(Names.Gui.Control.MODE_ALL);
    private final String strLayers = I18n.getString(Names.Gui.Control.MODE_LAYERS);
    private final String strMaterials = I18n.getString(Names.Gui.Control.MATERIALS);
    private final String strPrinter = I18n.getString(Names.Gui.Control.PRINTER);
    private final String strHide = I18n.getString(Names.Gui.Control.HIDE);
    private final String strShow = I18n.getString(Names.Gui.Control.SHOW);
    private final String strX = I18n.getString(Names.Gui.X);
    private final String strY = I18n.getString(Names.Gui.Y);
    private final String strZ = I18n.getString(Names.Gui.Z);
    private final String strOn = I18n.getString(Names.Gui.ON);
    private final String strOff = I18n.getString(Names.Gui.OFF);
    ...
    public void initGui() {
        ...
        this.btnMove = new GuiButton(id++, this.width - 90, this.height - 80, 80, 20, I18n.getString(Names.Gui.Control.MOVE_HERE));
        this.buttonList.add(this.btnMove);

        this.btnFlip = new GuiButton(id++, this.width - 90, this.height - 55, 80, 20, I18n.getString(Names.Gui.Control.FLIP));
        this.buttonList.add(this.btnFlip);

        this.btnRotate = new GuiButton(id++, this.width - 90, this.height - 30, 80, 20, I18n.getString(Names.Gui.Control.ROTATE));
    ...
    protected void actionPerformed(GuiButton guiButton) {
        if (guiButton.enabled) {
            ...
            if (guiButton.id == this.numericX.id) {
                ...
                String worldServerName = WorldServerName.worldServerName(this.mc);
                ...
                if (player != null) {
                    if (ClientProxy.addCoordinatesAndRotation(
                        ...
                        mc.thePlayer.addChatMessage(strSaveCoordinatesSuccess);
                    } else {
                        mc.thePlayer.addChatMessage(strSaveCoordinatesFail);
                    }
                }
            }
        }
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        if (this.schematic != null) {
            drawString(this.fontRenderer, this.strName + ": " + this.schematic.name, 10, this.height - 195, 0xFFFFFF);
        }
