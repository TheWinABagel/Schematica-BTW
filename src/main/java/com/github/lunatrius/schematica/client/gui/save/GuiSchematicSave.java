...
public class GuiSchematicSave extends GuiScreenBase {
    ...
    private final String strSaveSelection = I18n.getString(Names.Gui.Save.SAVE_SELECTION);
    ...
    public void initGui() {
        ...
        this.btnPointA = new GuiButton(id++, this.centerX - 130, this.centerY - 55, 100, 20, I18n.getString(Names.Gui.Save.POINT_RED));
        ...
        this.btnPointB = new GuiButton(id++, this.centerX + 30, this.centerY - 55, 100, 20, I18n.getString(Names.Gui.Save.POINT_BLUE));
        ...
        this.btnSave = new GuiButton(id++, this.width - 50, this.height - 30, 40, 20, I18n.getString(Names.Gui.Save.SAVE));
